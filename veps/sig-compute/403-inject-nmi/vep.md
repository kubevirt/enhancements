...
1. `virt-api` authenticates and authorizes the request, validates the VMI state, and forwards the request to `virt-handler`.
...
- Implements the VMI NMI injection subresource end to end
