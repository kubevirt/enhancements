...
- This VEP targets alpha for version: v0.59.0
...
KubeVirt has supported VSOCK since v0.59.0, when it was introduced as an
alpha feature via a
[community proposal](https://github.com/kubevirt/community/pull/191).
Linux 7.0
