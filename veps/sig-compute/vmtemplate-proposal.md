...
See [Implementation phases](#implementation-phases-v1alpha1) and [Feature
...
* Phase 4: Implementation of the new `virtctl` commands
* Phase 5: Integration of the feature within the core KubeVirt repository

The import and export feature (OVA/OVF) is anticipated to be worked on in
the development cycle for v1.8.0.
