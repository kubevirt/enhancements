...
2. Devices have to be of the type GPU, HostDevices, or Network devices (SR-IOV).
...
```
kubevirt.io/dra-network-macs: '{"<claimName>/<requestName>":"de:ad:00:00:be:ef"}'
```
...
Instead, CDI (Container Device Interface) will inject device information as a file into each pod. The file structure 
will contain mappings of request/claim to PCI addresses:
```
request/claim: <list of pci addresses>
```
