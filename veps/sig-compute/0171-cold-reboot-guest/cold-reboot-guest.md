...
### Alpha
I suggest we skip Alpha. Beta is protected by the same feature gate and there is no functional difference between the two stages for this VEP.

### Beta
- Implementation behind a feature gate RecreateVMIOnReboot
- API, e2e tests implemented and the added toggle documented
