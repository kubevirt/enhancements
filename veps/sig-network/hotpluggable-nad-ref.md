...
- Low risk: It leverages live migration which already exists and would follow a similar workflow as hotplug/unplug or network interfaces, which has been stable in production.
