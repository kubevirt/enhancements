...
- **RPM dependency resolution**: Remove the Bazel dependency from RPM resolution. The approach is TBD — bazeldnf standalone is being explored (see [kubevirt#18534](https://github.com/kubevirt/kubevirt/pull/18534)).
